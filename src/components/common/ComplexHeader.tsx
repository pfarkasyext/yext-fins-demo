...
//         <Logo />
//         <h1 className="text-3xl font-bold text-brand-blue">Capital</h1>
//         <div className="h-12 w-[2px] bg-brand-orange"></div>
//         <div className="flex flex-col text-brand-blue">
//           <span className="leading-none">Wealth</span>
//           <span className="leading-none">Management</span>
//         </div>
//       </div>
//     </header>
//   );
