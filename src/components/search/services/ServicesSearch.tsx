      ...
      <div className="flex flex-col w-full my-8">
        <div className="w-full flex">
          <Facets
            customCssClasses={{
              facetsContainer:
                "Facet-showMore mr-6 block min-w-max hidden md:block pt-1",
              optionsContainer: "mb-2 flex flex-col gap-1",
              titleLabel:
                "text-md mb-2 border rounded-xl text-center bg-slate-100 p-2",
            }}
          >
            <StandardFacet
              collapsible={false}
              fieldId={"fins_serviceCategory"}
            />
          </Facets>
                  ...
                  <ResultsCount
                    customCssClasses={{
                      resultsCountContainer:
                        "text-md font-normal px-0 py-1 m-0",
                    }}
                  />
                  <AppliedFilters
                    customCssClasses={{
                      ...
                      removableFilter:
                        "bg-gray-100 rounded-sm border border-brand-gray-300 text-md px-2 py-1",
